    ...
    <div class="max-w-5xl mx-auto md:px-8 xl:px-0">
      ...
      <div class="relative z-20 flex flex-col max-w-lg mx-auto text-center">
        ...
        <h1
          ...
          "
        >
          Welcome to the Hosiptal Equipments.
        </h1>
        <a
          href="#_"
          class="
        ...
        <div class="relative z-10 w-full md:w-1/2 lg:w-2/3">
          <img
            ...
            class="
              ...
              transform
              scale-125
              md:scale-150 md:origin-top-right
              lg:translate-x-48 lg:-translate-y-16
            "
          />
        </div>
      </div>
        ...
        <div class="relative z-10 w-full md:w-1/2 lg:w-2/3">
          <img
            ...
            class="
              ...
              transform
              scale-110
              md:scale-125 md:origin-top-right md:translate-x-20
            "
          />
        </div>
        <div
